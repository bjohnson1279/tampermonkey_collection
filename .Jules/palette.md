...
## 2024-11-29 - Native UI Harmonization and WCAG Touch Targets
...
**Action:** Always inspect the host application's native UI design tokens (e.g., YouTube's 36px pill buttons) and replicate their dimensions and padding to simultaneously achieve aesthetic harmonization and resolve touch target accessibility issues.
